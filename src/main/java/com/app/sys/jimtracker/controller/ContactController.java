...
import com.app.sys.jimtracker.repository.ContactRepository;
...
public class ContactController 
{
  ...
  @PutMapping(value="/{id}")
  public ResponseEntity<ContactEntity> update(@PathVariable("id") long id,@RequestBody ContactEntity contact)
  {
    return repository.findById(id)
        .map(record -> {
            ...
            ContactEntity updated = repository.save(record);
